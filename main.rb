...
class Game
  ...
  def check_winner(player_rank, computer_rank)
  	if player_rank[0] > computer_rank[0]
  		puts "\n\tYou win! You walk away with #{player_one.chips + community.pot} chips!"
  	elsif player_rank[0] < computer_rank[0]
  		puts "\n\tWomp! You've lost this hand. You have #{player_one.chips} chips."
